...
import { Video, FileText, CheckCircle, BrainCircuit, PlayCircle, Loader2, Save, Share2, MousePointer2 } from 'lucide-react';
...
const TeacherFeatures = () => {
    ...
    return (
        <section id="features" style={{ padding: '6rem 1rem', background: 'transparent' }}>
            <div className="container">
                ...
                >
                    ...
                    <motion.div
                        animate={{
                            top: getCursorY(),
                            left: 150, // Center of sidebar roughly
                    ...
                    {/* Sidebar */}
                    <div style={{ background: '#F9FAFB', borderRight: '1px solid #E5E7EB', padding: '1.5rem', position: 'relative' }}>
                    ...
                    {/* Main Content Area */}
                    <div style={{ padding: '2rem', background: 'white', display: 'flex', flexDirection: 'column' }}>
                        {/* Header */}
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {/* Prompt Input Area - Static for demo */}
                                <div style={{ marginBottom: '2rem' }}>
                                    <div style={{ display: 'flex', gap: '1rem' }}>
                                        ...
                                        <div style={{ padding: '0.75rem 1.5rem', borderRadius: '0.5rem', background: '#E5E7EB', color: 'white', minWidth: '100px' }}>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ flex: 1, background: '#F9FAFB', border: '1px dashed #D1D5DB', borderRadius: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                                    <div style={{ width: '100%', height: '100%', padding: '2rem', display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        {activeTab === 'quiz' && (
                                            ...
                                            >
                                                <div style={{ padding: '1rem', background: 'white', border: '1px solid #10B981', borderRadius: '0.5rem', display: 'flex', justifyContent: 'space-between' }}>
